...
const FriendDetails = () => {
  ...
  const allInteractions = getTimelineEvents();
  const recentInteractions = friend
    ? allInteractions.filter(e => e.friendId === friend.id)
    : [];
  ...
  const handleAction = (type) => {
    ...
    // NOTE: no local state update needed anymore
  };
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white rounded-xl p-6 sm:p-8 border border-gray-100 shadow-sm">
              <div className="flex flex-col items-center text-center">
                ...
                {/* Tags (safe) */}
                {Array.isArray(friend.tags) && friend.tags.length > 0 && (
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div key={label} className="bg-white rounded-xl p-4 text-center border border-gray-100 shadow-sm">
                  ...
                  <p className={`text-lg sm:text-2xl font-semibold mt-1 ${color}`}>
                    {value}
                  </p>
                </div>
              ))}
